...
*/
#define STEPS_PER_M_X                   (6302)
#define STEPS_PER_M_Y                   (4731  * 2)
#define STEPS_PER_M_Z                   (160000 * 2) // M8 (1.25mm), 200 step/360 deg

/// http://blog.arcol.hu/?p=157 may help with this one
// 146 lepes 15 mm
//#define STEPS_PER_M_E                   (9733 * 2)
//#define STEPS_PER_M_E                   (23173)
//#define STEPS_PER_M_E                   (20000)
#define STEPS_PER_M_E                   (44120)
...
#define Z_STEP_PIN                      DIO20
#define Z_DIR_PIN                       DIO21
#define Z_MIN_PIN                       DIO28
//#define   Z_MAX_PIN                       DIO29
...
#define E_STEP_PIN                      DIO14
#define E_DIR_PIN                       DIO15
//#define E_ENABLE_PIN                  xxxx
//#define   E_INVERT_DIR
//#define   E_INVERT_ENABLE

#define   PS_ON_PIN                     DIO52
//#define PS_MOSFET_PIN         xxxx
//#define	STEPPER_ENABLE_PIN		DIO52
...
//#define TEMP_HYSTERESIS             10 // eddig 10 volt!
...
// PL5 = DIO44
//            name      port   pwm
DEFINE_HEATER(extruder, PE4,   1)
DEFINE_HEATER(bed,      PE3,   0)
DEFINE_HEATER(fan,      PE5,   1)
